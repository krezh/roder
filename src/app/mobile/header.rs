...
use crate::app::state::{ConnectionState, NavOpen, NsPaletteOpen, PaletteOpen};
...
pub(crate) fn MobileHeader() -> impl IntoView {
    ...
    view! {
        <header class="mobile-topbar">
            ...
            <span class="mobile-brand" class:mobile-brand-disconnected=move || connected.get().is_some()
                on:click=move |_| selected_kind.set(None)>"Roder"</span>
